...
#define _DUTY_MAX 1990 // servo full counterclockwise position (180 degree)
...
void loop() {
  ...
  if (dist_ema<=180.0) {
    ...
    int dist = map(dist_ema/10.0, 18, 36, _DUTY_MIN, _DUTY_MAX);
    myservo.writeMicroseconds(dist);
    }
